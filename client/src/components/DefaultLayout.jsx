...
import { Menu, Code, Home, Users, Settings, LogOut, Plus, ClipboardList, Trophy, UserCheck, Eye } from 'lucide-react';
  ...
  const getNavigationItems = () => {
    const navItems = {
      admin: [
        ...
        { label: 'Role Mapping', icon: UserCheck, path: '/admin/role-mapping' },
      ...
      participant: [
        ...
        { label: 'My Team', icon: Users, path: '/participant' },
      ],
      evaluator: [
        { label: 'Dashboard', icon: Home, path: '/evaluator-dashboard' },
        { label: 'Submissions', icon: ClipboardList, path: '/evaluator-dashboard' },
      ]
    };
